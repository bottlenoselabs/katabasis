...
namespace Katabasis
{
    ...
    internal class PipelineCache
    {
        ...
        private readonly Dictionary<StateHash, BlendState> _blendCache = new Dictionary<StateHash, BlendState>();
        private readonly Dictionary<StateHash, DepthStencilState> _depthStencilCache = new Dictionary<StateHash, DepthStencilState>();
        private readonly Dictionary<StateHash, RasterizerState> _rasterizerCache = new Dictionary<StateHash, RasterizerState>();
        private readonly Dictionary<StateHash, SamplerState> _samplerCache = new Dictionary<StateHash, SamplerState>();
        ...
        internal readonly struct StateHash : IEquatable<StateHash>
        {
            ...
            {
                return Convert.ToString((long)_a, 2).PadLeft(64, '0') + "|" +

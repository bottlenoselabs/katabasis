...
namespace Katabasis
{
    internal static class SDL2_FNAPlatform
    {
        ...
        private static readonly List<Game> _activeGames = new List<Game>();
        ...
        private static readonly bool OSXUseSpaces =
            SDL_GetPlatform().Equals("Mac OS X") && // Prevents race with OSVersion
        ...
        private static readonly Dictionary<int, int> _instanceList = new Dictionary<int, int>();
        ...
        */
        ...
        private static readonly Dictionary<int, Keys> _scanMap = new Dictionary<int, Keys>
        {
        ...
        private static readonly Dictionary<int, SDL_Scancode> _xnaMap =
            new Dictionary<int, SDL_Scancode>
            {
        ...
        public static string ProgramInit(LaunchParameters args)
        {
            ...
            if (_osVersion.Equals("Windows") ||
                ...
                _osVersion.Equals("FreeBSD") ||
                _osVersion.Equals("OpenBSD") ||
                _osVersion.Equals("NetBSD"))
            {
            ...
            SDL_PumpEvents();
            while (SDL_PeepEvents(evt, 1, SDL_eventaction.SDL_GETEVENT, SDL_EventType.SDL_CONTROLLERDEVICEADDED, SDL_EventType.SDL_CONTROLLERDEVICEADDED) == 1)
            {
        ...
        {
            return (SDL_GetWindowFlags(window) & (uint)SDL_WindowFlags.SDL_WINDOW_RESIZABLE) != 0;
        }
        ...
        {
            return (SDL_GetWindowFlags(window) & (uint)SDL_WindowFlags.SDL_WINDOW_BORDERLESS) != 0;
        }
        ...
        {
            return !string.IsNullOrEmpty(_osVersion) && (_osVersion.Equals("iOS") || _osVersion.Equals("Android"));
        }
        ...
        {
            if (SDL_GetPlatform().Equals("Emscripten"))
            {
        ...
        {
            SDL_SetRelativeMouseMode(enable ? SDL_bool.SDL_TRUE : SDL_bool.SDL_FALSE);
        }
        ...
        {
            return (int)SDL_GetQueuedAudioSize(handle);
        }

        public static void StartMicrophone(uint handle)
        {
            SDL_PauseAudioDevice(handle, 0);
        }
        ...
        private static bool PollEvent(ref SDL_Event evt, Game game, ref GraphicsAdapter currentAdapter, bool[] textInputControlDown, int[] textInputControlRepeat, ref bool textInputSuppress)
        {

...
namespace Ankura
{
    ...
    public class SpriteBatch : GraphicsResource
    {
        ...
        */
        ...
        private static readonly float[] AxisDirectionX =
        {
            -1.0f,
            1.0f,
            -1.0f,
        ...
        private static readonly float[] AxisDirectionY =
        {
            -1.0f,
            -1.0f,
            1.0f,
        ...
        private static readonly float[] AxisIsMirroredX =
        {
            0.0f,
            1.0f,
            0.0f,
        ...
        private static readonly float[] AxisIsMirroredY =
        {
            0.0f,
            0.0f,
            1.0f,

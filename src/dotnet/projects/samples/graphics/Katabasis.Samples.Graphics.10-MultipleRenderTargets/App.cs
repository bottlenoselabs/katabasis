...
namespace Katabasis.Samples
{
    public class App : Game
    {
        ...
        public App()
        {
            Window.Title = "Katabasis Samples; Graphics: Cube Multiple Render Targets (MRT)";
        }

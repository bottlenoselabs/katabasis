...
#pragma warning restore SA1312
		...
		public static bool GetWindowResizable(IntPtr window) => (SDL_GetWindowFlags((SDL_Window*)window) & (uint)SDL_WindowFlags.SDL_WINDOW_RESIZABLE) != 0;

		public static void SetWindowResizable(IntPtr window, bool resizable) => SDL_SetWindowResizable((SDL_Window*)window, resizable);

		public static bool GetWindowBorderless(IntPtr window) => (SDL_GetWindowFlags((SDL_Window*)window) & (uint)SDL_WindowFlags.SDL_WINDOW_BORDERLESS) != 0;

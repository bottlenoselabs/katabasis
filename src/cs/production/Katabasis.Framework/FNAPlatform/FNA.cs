...
namespace bottlenoselabs.Katabasis
{
    ...
    public static unsafe class FNA
    {
        ...
        private static readonly FNA3D_Image_ReadFunc _readFunc;
        private static readonly FNA3D_Image_WriteFunc _writeFunc;
        private static readonly FNA3D_Image_SkipFunc _skipFunc;
        private static readonly FNA3D_Image_EOFFunc _eofFunc;

        static FNA()
        {
	        _readFunc.Data.Pointer = &INTERNAL_Read;
	        _writeFunc.Data.Pointer = &INTERNAL_Write;
	        _skipFunc.Data.Pointer = &INTERNAL_Skip;
	        _eofFunc.Data.Pointer = &INTERNAL_EOF;
        }

        [UnmanagedCallersOnly]
        private static int INTERNAL_Read(
			void* context,
			Runtime.CString data,
			int size)
		{
			Stream stream;
			lock (_readStreams)

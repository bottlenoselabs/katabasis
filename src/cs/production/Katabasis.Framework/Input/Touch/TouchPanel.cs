...
namespace bottlenoselabs.Katabasis
{
	...
	public static class TouchPanel
	{
		...
		private static readonly Queue<GestureSample> _gestures = new();
		...
		private static readonly List<TouchLocation> _validTouches = new();
		...
		public static TouchPanelCapabilities GetCapabilities() => FNAPlatform.GetTouchCapabilities();
		...
		internal static void EnqueueGesture(GestureSample gesture) => _gestures.Enqueue(gesture);

...
namespace bottlenoselabs.Katabasis
{
	...
	public unsafe class AudioEmitter
	{
		...
		internal F3DAUDIO_EMITTER _emitterData;
		...
		public AudioEmitter()
		{
			...
			_emitterData.pCone = (F3DAUDIO_CONE*)IntPtr.Zero;
			...
			_emitterData.pVolumeCurve = (F3DAUDIO_DISTANCE_CURVE*)IntPtr.Zero;
			_emitterData.pLFECurve = (F3DAUDIO_DISTANCE_CURVE*)IntPtr.Zero;
			_emitterData.pLPFDirectCurve = (F3DAUDIO_DISTANCE_CURVE*)IntPtr.Zero;
			_emitterData.pLPFReverbCurve = (F3DAUDIO_DISTANCE_CURVE*)IntPtr.Zero;
			_emitterData.pReverbCurve = (F3DAUDIO_DISTANCE_CURVE*)IntPtr.Zero;
